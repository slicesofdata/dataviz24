---
title: "*Installing Git and Setting Up Git and GitHub for R Projects*"
...
We will perform all the necessary tasks for using Git with RStudio and managing files at the remote repository at GitHub. You will create a GitHub account if you do not have one; install Git on your computer if needed; configure Git on RStudio; and create a RStudio project. 


### **To Do: Steps of the Task**

1. Create a GitHub account
2. Create GitHub repository: "dataviz-exercises" 
...
2. Name the repository **dataviz-exercises** and provide a description like *"for dataviz class exercises and homework"*.
