...
Homework: Make an R Markdown report that sources your scripts. to merge the files. This should read all data, clean, pivot, join, etc. 

In your visualize script, create a plot. And ggsave it as a png.

then insert into the report.
...
1. Identify variables that represent categorical groups and convert them into factors. This could be performed in a joined file but ideally you would 
