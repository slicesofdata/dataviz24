...
All model have assumptions. Interpreting models should be done within the context of those assumptions. At very least, get some practice checking some model diagnostics and assumptions using functions from the **{performance}** library (e.g., `check_residuals()`, `check_outliers()`, `check_normality()`, `check_collinearity()`).
