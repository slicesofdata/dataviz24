...
- A [date file](https://github.com/slicesofdata/dataviz24/raw/main/data/baby-names-2008.csv) for the exercise
...
ggsave(filename = here::here("figs", "plot_baby_hist.png"), 
       plot = baby_hist,
       device = "png"
       )
```
