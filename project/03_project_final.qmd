...
* that visualizations contain **Alt text** (alternative text) for screen readers; [What is alt text?](https://accessibility.huit.harvard.edu/describe-content-images); see [Make your document, presentation and sheets more accessible](https://support.google.com/docs/answer/6199477?hl=en-GB) and [How to add alternative text to an object in google slides](https://www.howtogeek.com/450847/how-to-add-alternative-text-to-an-object-in-google-slides/) 
