...
2. The **team work collaboratively** using Box Edit, Docs in [Proton Drive](https://proton.me/blog/docs-proton-drive) which is free and privat, or GoogleDocs. **However, due to Google Privacy Issues, you cannot use GoogleDocs without a written approval from your team's liaison.** All team members can see the written content and make edits. A limitation is that R code blocks, R in-line code, and plots would not be visible unless added to the document.  
